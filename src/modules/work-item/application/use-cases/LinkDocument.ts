...
export class LinkDocument {
    ...
    async execute(workItemId: string, workspaceId: string, documentId: string): Promise<WorkItemDocument> {
        ...
        // 4. Create the link
        return this.workItemDocumentRepo.link(workItemId, documentId);
    }
}
